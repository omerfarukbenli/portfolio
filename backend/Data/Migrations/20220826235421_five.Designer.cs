            ...
            modelBuilder.Entity("PersonalPortfolioWebSite.Entities.Concrete.Models.About", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CvEnglish = "Hello, if I need to introduce myself briefly, my name and surname is Ömer Faruk Benli.I was born on 26.02.1993 in Istanbul. My university education, Sakarya University-Labor Economy and Industrial Relations with a GPA of (3.52). After university education, I worked as an assistant real estate appraiser in the private sector for 3.5 years. In 2021 Istarted to take sofwtware trainings with the idea pf dping it in the software industry. Software It focuses on C# and Javascript as the language, Asp.Net CORE and Angular as the framework, and MsSQL and MongoDB as the database.I create using these technologies. Currently, as a Freelence project, the promotion site of an elevator manufacturer company I'm busy programming it as full-stack. Thanks for visiting my site.     ",
